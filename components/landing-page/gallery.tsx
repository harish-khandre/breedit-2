        ...
        <div className="container  py-12 px-14 mx-auto flex flex-wrap">
          <Link href="https://www.reddit.com/r/BREEDITT/">
            <div className="flex w-full mb-14 flex-wrap">
              <h1 className="sm:text-3xl font-bold title-font  lg:w-1/3 lg:mb-0 mb-4  hover:text-primary tracking-wide text-2xl  hover:underline underline-offset-8 decoration-1 duration-500 ">
                Top-voted Photos on Our Reedit page
              </h1>
              <p className="lg:pl-16 lg:w-2/3 mx-auto leading-relaxed text-lg  text-primary ">
