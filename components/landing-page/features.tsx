...
const Features = () => {
  return (
    <>
      <section className="  my-2 body-font bg-secondary lg:m-16 lg:rounded-3xl md:rounded-none authBlogCard pt-2 font-bold">
        <div className="container px-8 py-8 mx-auto">
          <div className="text-center mb-8">
            <h1 className="sm:text-3xl text-2xl pb-4 text-primary title-font mb-4">
          ...
          <div className="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6">
            <div className="p-4 md:w-1/3 flex flex-col text-center items-center">
              <div className="w-20 h-20 inline-flex items-center justify-center rounded-full bg-primary text-primary-foreground mb-5 flex-shrink-0">
                <svg
                  fill="none"
                  stroke="currentColor"
                  strokeLinecap="round"
              ...
              <div className="flex-grow">
                <h2 className="text-primary text-lg title-font mb-3">
                  Expert Breeding
                </h2>
                ...
                <Link href="/" className="mt-3  inline-flex items-center pt-6">
                  Learn More
                  <svg
                    fill="none"
                    stroke="currentColor"
            ...
            <div className="p-4 md:w-1/3 flex flex-col text-center items-center">
              <div className="w-20 h-20 inline-flex items-center justify-center rounded-full bg-primary mb-5 flex-shrink-0">
                <svg
                  fill="none"
                  stroke="currentColor"
                  strokeLinecap="round"
            ...
            <div className="p-4 md:w-1/3 flex flex-col text-center items-center">
              ...
              <div className="flex-grow">
                <h2 className=" text-lg title-font mb-3 text-primary ">
                  Selection of Breeds
                </h2>
                <p className="leading-relaxed text-base ">
                ...
                <Link href="/" className="mt-3 inline-flex items-center pt-4">
                  Learn More
                  <svg
                    fill="none"
                    stroke="currentColor"
          ...
          <Button size="lg" className="flex mx-auto mt-8  py-4 px-8 ">
            {" "}
            Search{" "}
          </Button>
        </div>
